...
def main():
	...
	if not ((sys.version_info[0]>=3) and (sys.version_info[1]>=6)):
		print("please upgrade your python to version 3.6 +")
		sys.exit(0)
	# parsing parameters
	opts, args = getopt.getopt(sys.argv[1:], 'a:b:m:p:t:o:')
	
	if len(opts)<5:
		print("please check your inputs!")
		print("python TarPmiR.py -a <mir> -b <mRNA> -m <model> -p <probability_cut> -t <n_threads> -o <out_loc>")
		sys.exit(0)
	...
	for i in opts:
		...
		if i[0]=='-p':
			pb_cut=float(i[1])
		if i[0]=='-t':
			n_threads_input=int(i[1])
		if i[0]=='-o':
			output_file=os.path.abspath(i[1])
